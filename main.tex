...
Construct a quadrilateral MORE where $MO = 6, OR = 4.5, \angle M = 60 \degree, \angle 0 = 105 \degree$ and $\angle R = 105 \degree$.
%
\section{SOLUTION}
...
E(-6.49,-3.42)
\end{align}
    \item Now, we have the coordinate of vertices M,O,R,E as M(0,0); O(6,0); R(8.25,-1.46) ;E(-6.49,-3.42).
